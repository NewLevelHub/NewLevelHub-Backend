...
class User(AbstractBaseUser, PermissionsMixin, TimeStampedModel):
    ...
    phone = models.CharField(max_length=20, blank=True, null=True, unique=True, db_index=True, verbose_name='Phone number')
    ...
    # Role & Status
    role = models.CharField(max_length=20, choices=ROLE_CHOICES, default='employee', db_index=True, verbose_name='User role')
