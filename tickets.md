[
  ...
  },
  {
    ...
    "acceptanceCriteria": [
      ...
      "После регистрации по инвайту отправляется verification email; токены не возвращаются — пользователь должен верифицировать email перед первым входом. Логин с is_email_verified=False возвращает 403.",
